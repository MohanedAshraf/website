...
export default function BrandTile() {
  ...
  return (
    <Card variant="glass" className="relative flex h-full w-full items-center justify-center">
      <motion.svg
        key={theme}
        className="absolute inset-0 w-full h-full text-black dark:text-white pointer-events-none"
      ...
      >
        <motion.path
          ...
          fill="currentColor"
          opacity={0.15}
          variants={{ hidden: { scale: 0.8, y: -30 }, show: { scale: 1, y: 0 } }}
        ...
        <motion.path
          ...
          fill="currentColor"
          opacity={0.12}
          variants={{ hidden: { scale: 0.8, x: -40 }, show: { scale: 1, x: 0 } }}
          transition={{ duration: 0.8, ease: "easeOut" }}
        />
        <motion.path
        ...
        <motion.path
          ...
          fill="currentColor"
          opacity={0.1}
          variants={{ hidden: { scale: 0.85, y: 40 }, show: { scale: 1, y: 0 } }}
          transition={{ duration: 0.8, ease: "easeOut" }}
        />
        <motion.path
