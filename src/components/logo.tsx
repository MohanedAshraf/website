...
export default function Logo() {
  return (
    <Link href="/" className="relative group block" aria-label="Home">
       ...
       <div className="absolute inset-0 flex items-center justify-center pointer-events-none opacity-50 group-hover:opacity-100 transition-opacity duration-500">
         <div className="absolute w-[150%] h-[150%] bg-amber-500/30 rounded-full blur-[20px] translate-x-[-20%] translate-y-[-10%]" />
         <div className="absolute w-[150%] h-[150%] bg-teal-500/30 rounded-full blur-[20px] translate-x-[20%] translate-y-[10%]" />
       </div>

      <motion.svg
        className="w-10 h-10 text-foreground relative z-10"
